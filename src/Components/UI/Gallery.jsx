...
const Gallery = () => {
  ...
  return (
    ...
    >
      ...
      <div className="ss:h-screen sm:h-screen lg:h-[150vh] lg:w-[90%] mx-auto grid grid-cols-2 ss:grid-cols-3 sm:grid-cols-3 lg:grid-cols-3 place-items-center xs:gap-3 ss:gap-4 sm:gap-5 lg:gap-6">
        <div className="rounded-[2rem] w-full h-full overflow-hidden relative">
          <img
            src="/Images/Gallery/1.webp"
            alt="sweatbox gallery"
            className="galleryImg w-full h-[120%] object-cover object-center "
          />
        </div>
        <div className="rounded-[2rem] w-full h-full overflow-hidden relative">
          <img
