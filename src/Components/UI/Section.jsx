...
const Section = () => {
  ...
  return (
    <div
      ...
      className="py-8 ss:py-10 sm:py-10 lg:py-20 w-full relative"
    >
      ...
      <div className="h-[95vh] w-full flex flex-col ss:flex-row sm:flex-row lg:flex-row justify-between items-center xxs:gap-y-4 xs:gap-y-4">
        <div className="ss:w-[39%] sm:w-[39%] lg:w-[39%] xxs:w-full xs:w-full h-full flex flex-row justify-between">
          <div
            ...
            className="leftCard w-[72%] flex flex-col justify-between items-center bg-white h-full rounded-[2rem] p-4 ss:p-2 sm:p-4 lg:p-6 xl:p-7"
          >
            <div className="overflow-hidden h-[80%] rounded-[2rem]">
              <img
                src="/Images/gym1.jpg"
                alt="trainer image sweatbox"
                className="sectionImg w-full h-full object-cover rounded-[2rem]"
                style={{ clipPath: "inset(0% 0% 0% 0%)" }}
              />
            </div>
            <p className="text-left w-full text-2xl ss:text-3xl sm:text-4xl lg:text-5xl xl:text-[4.1rem] leading-[1] font-bold font-Akira">
              Our <br /> Coaches
            </p>
          </div>
